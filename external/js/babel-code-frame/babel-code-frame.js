var codeFrame = (function () {
	...
	function requireLib () {
		...
		function isColorSupported() {
		  return (typeof browser$1 === "object" && (browser$1.env.FORCE_COLOR === "0" || browser$1.env.FORCE_COLOR === "false") ? false : picocolors.isColorSupported
		  );
		}
	...
	var codeFrame = /*#__PURE__*/_mergeNamespaces({
		__proto__: null,
		default: index
	}, [libExports]);
